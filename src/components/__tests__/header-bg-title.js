...
describe(`SimpleTitle`, () => {
  it(`renders correctly`, () => {
    const tree = renderer.create(<HeaderBgTitle title="KCVV Elewijt" />).toJSON()
...
describe(`ClassnameTitle`, () => {
  it(`renders correctly`, () => {
    const tree = renderer.create(<HeaderBgTitle title="KCVV Elewijt" classes="title--large" />).toJSON()
    expect(tree).toMatchSnapshot()
  })
})
