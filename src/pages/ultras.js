      ...
      <Layout>
        ...
        <div className={'ultras-wrapper'}>
          ...
          <p>
            ...
            eerste sfeeracties. Bengaals vuur en rookpotten werden aangekocht,
          ...
          <p>
            ...
            gecombineerd met een "Schijt je rijk", waarbij maar liefst 500
            lotjes verkocht werden aan sympathisanten. De winnaar kreeg een
            cheque uitgereikt van maar liefst 750 euro!
          </p>
          <CardImage title="Schijt je rijk" localFile={sjr} metadata={false} />
          <h2>Lid worden</h2>
          <p>
            De makkelijkste manier om op de hoogte te blijven van acties,
            busritten, evenementen... is via onze vernieuwde facebookpagina:<br/>
            <a
              className={'btn btn--arrow'}
              href="https://www.facebook.com/KCVV.ULTRAS/"
              target="_blank"
            >
              <i class="fa fa-facebook-square" aria-hidden="true"></i> facebook.com/KCVV.ULTRAS
            </a>
          </p>
        </div>
      </Layout>
