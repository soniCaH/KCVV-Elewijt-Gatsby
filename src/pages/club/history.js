      ...
      <ScrollAnimation animateOnce="true" initiallyVisible="true">
        <div class="timeline-content">
          ...
          <p>
            ...
            schouder een rode band was gewerkt, dus “Wit en Rood” met zwarte
            broek. Vanuit deze periode dateert ook de eerste vermelding in de
            krant ter ere van de inhuldiging van burgemeester Nauwelaerts op
            04/07/1911: “Van Campenhout hield de toespraak namens de Jonge
            Footbalclub” (Nieuwsblad 5/7/1911). In die tijd waren er nog geen
            kampioenschappen zoals we ze heden kennen. Het waren enkel vrienden-
            en bekerwedstrijden die betwist werden. Om hun verplaatsingskosten
            (verre afstanden) te dekken, speelden ze zelf toneel “In den Prins”
            onder leiding van E.H. Langendries; destijds onderpastoor in de
            Elewijtse parochie. De wereldoorlog ’14-’18 brak uit en haast alle
            spelers moesten soldaat worden en meteen werd ook de voetbalsport
            tijdelijk opgedoekt.
          </p>
        </div>
      </ScrollAnimation>
    ...
    <div class="timeline-item">
      ...
      <ScrollAnimation animateOnce="true" initiallyVisible="false">
        <div class="timeline-content right">
          ...
          <p>
            Na de oorlog van ’14-’18 werd er opnieuw een club opgericht die de
            naam meekreeg van FC Leopold Elewijt. Het waren niet allen meer
            dezelfde spelers van voor de oorlog, maar wel een groot deel van de
            jongere generatie. Ook speelden ze niet meer in de “Wit-Rood”
            kleuren (omdat er niets meer van overbleef) en moesten ze uitzien
            naar een ander speelveld. Nu speelden ze met de kleuren “Geel en
            Rood” en verhuisden ze richting “Koffer”, tussen de Kastanjedreef en
            de Steenbergstraat. Voor niet lang echter, want ze kregen last en
            ...
            achter “Koffer”, waar ze meteen hun lokaal vestigden. Na zekere tijd
            moest het speelveld opnieuw verlaten worden; voor de derde maal werd
            er verhuisd en de ploeg kwam dichter bij het dorp spelen. Zij namen
            het terrein in bezit dat jaren door SK Elewijt (Groen-Wit) gebruikt
            werd aan de Voetbalstraat (huidige Sweynbeerstraat).
          </p>
        </div>
      </ScrollAnimation>
    </div>
    ...
    <div class="timeline-item">
      ...
      <ScrollAnimation animateOnce="true" animateIn="fadeInLeftBig">
        <div class="timeline-content">
          ...
          <p>
            De “Leopold” heeft vele mooie dagen gekend als ploeg aangesloten in
            de Vlaamse Voetbalbond. Er werd vooral gespeeld tegen clubs als
            “Albert” Hofstade en Superior Bonheiden. De ploeg was ook één
            seizoen aangesloten bij de Belgische voetbalbond in het seizoen
            1927-1928; de club kreeg stamnummer 1037 en sloot zich aan onder de
            naam Voetbal Club Léopold Elewyt. In dat seizoen belandde Léopold
            Elewijt op een verdienstelijke derde plaats na een seizoen met 4
      ...
      <ScrollAnimation animateOnce="true" animateIn="fadeInRightBig">
        <div class="timeline-content right">
          ...
          <p>
            ...
            werd vrij vlug werkelijkheid: de “Leopold” werd ontbonden. Al het
            materiaal, de bekers en de trofeeën werden onderling verdeeld of
            verloot onder hen die tot het bittere einde aan dek waren gebleven.
            Het terrein werd omgeploegd, de doelen in stukken gezaagd, en het
            was amen en uit met de Elewijtse voetbalsport.
          </p>
        </div>
      </ScrollAnimation>
    </div>
      ...
      <ScrollAnimation animateOnce="true" animateIn="fadeInRightBig">
        <div class="timeline-content right">
          ...
          <p>
            ...
            “Leopold” had gespeeld, in de Voetbalstraat (nu Sweynbeerstraat).
            Vanaf seizoen 1962-1963 verhuisde SK Elewijt naar de locatie aan de
            Driesstraat; destijds “Terwilgen-stadion” genoemd.
          </p>
        </div>
      </ScrollAnimation>
    </div>
      ...
      <ScrollAnimation animateOnce="true" animateIn="fadeInLeftBig">
        <div class="timeline-content">
          ...
          <p>
            ...
            “Leopold”). Hun lokaal werd de “Vuurmolen” bij Bertrand Van Poeyer
            terwijl een speelveld werd aangelegd op het Zwijnbeer, waar nu de
            scoutslokalen staan. Na de tweede wereldoorlog zou FC Elewijt
            verhuizen naar het terrein aan de Kastanjedreef (tussendoor werd ook
            nog een tijdje aan de Vekestraat gespeeld).
          </p>
        </div>
      </ScrollAnimation>
    </div>
      ...
      <ScrollAnimation animateOnce="true" animateIn="fadeInRightBig">
        <div class="timeline-content right">
          ...
          <p>
            ...
            de daaropvolgende seizoenen ’86-’87 en ’87-’88 behaalde Crossing
