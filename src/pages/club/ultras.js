    ...
    return (
      <Layout>
        ...
        <div className={`ultras-wrapper`}>
          <header>
            <h1>KCVV Ultras</h1>
            <CardImage title="KCVV Ultra's op kampioenenmatch" picture={champ} metadata={false} link={false} />
          </header>
          <section>
            <h2>Wie zijn we</h2>
            <p>
          ...
          <section>
            ...
            <CardImage title="Schijt je rijk" picture={sjr} metadata={false} link={false} />
          </section>
          <section>
            <h2>Lid worden</h2>
            <p>
