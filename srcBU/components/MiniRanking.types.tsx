interface MiniRankingDataTeamObject {
...
interface MiniRankingDataObject {
  name: string
  teams: Array<MiniRankingDataTeamObject>
  type: string
}

interface MiniRankingState {
  data: Array<MiniRankingDataObject>
  loading: boolean
}
